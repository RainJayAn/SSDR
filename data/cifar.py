...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, seed,root, train=True,valid=False,
                 transform=None, target_transform=None,
                 download=False,
                 noise_type=None, noise_rate=None, random_state=0):
        self.seed=seed
        ...
        if self.train:
            ...
            indices = np.random.RandomState(self.seed).permutation(len(self.train_labels))
            
            self.indice=indices
            indices1=indices[:45000]
            indices2=indices[45000:]
            if self.valid :
                self.train_labels = [self.train_labels[i] for i in indices2]
                self.train_data = [self.train_data[i] for i in indices2]
            else:
                self.train_labels = [self.train_labels[i] for i in indices1]
                self.train_data = [self.train_data[i] for i in indices1]
